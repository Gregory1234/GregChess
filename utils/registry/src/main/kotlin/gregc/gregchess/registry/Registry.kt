...
class PartialConnectedRegistry<K, T>(name: String, val base: FiniteBiRegistryView<*, K>) : Registry<K, T, PartialConnectedRegistry<K, T>.Block>(name), FiniteSplitRegistryView<K, T> {
    private val blocks = mutableMapOf<ChessModule, Block>()
