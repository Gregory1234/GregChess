...
fun <T1> View.getStringFormatF1(path: String): (T1) -> String = getVal(path, "string format", { _ -> path }, true) {
...
fun <T1, T2> View.getStringFormatF2(path: String): (T1, T2) -> String = getVal(path, "string format", { _, _ -> path }, true) {
