...
data class Move(
    ...
    val stopBlocking: List<Pos>, val startBlocking: List<Pos>,
    val neededEmpty: List<Pos>, val passedThrough: List<Pos>,
    val flagsNeeded: List<Pair<Pos, ChessFlagType>>, val flagsAdded: List<PosFlag>,
