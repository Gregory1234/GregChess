...
val PieceType.section get() = module.config.getConfigurationSectionOrThrow("Chess.Piece.$configName")
val PieceType.localChar get() = section.getStringOrThrow("Char").single()
